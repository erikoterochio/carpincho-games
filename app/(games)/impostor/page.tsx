  ...
  return (
    <>
      ...
      <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: FONT, color: 'var(--text)', display: 'flex', flexDirection: 'column' }}>
        ...
        <TopNav backHref="/" title="El Impostor" />

        <div style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
          <div style={{ maxWidth: 480, width: '100%', margin: '0 auto' }}>
          <div style={{ background: 'linear-gradient(135deg, #7f1d1d 0%, #dc2626 55%, #ef4444 100%)', padding: '26px 20px 30px', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ maxWidth: '58%' }}>
              ...
              <div style={{ fontSize: 32, fontWeight: 700, color: '#ffffff', lineHeight: 1, marginBottom: 10, fontFamily: FONT }}>El Impostor</div>
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.72)', lineHeight: 1.5, fontFamily: FONT }}>¿Podés encontrar al infiltrado del grupo?</div>
            </div>
          </div>
          ...
          <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ background: 'var(--surface)', borderRadius: 14, padding: '18px 16px', border: '1px solid var(--border)' }}>
              <div style={{ fontSize: 13, color: 'var(--text-soft)', lineHeight: 1.7 }}>Un jugador recibe una palabra diferente. Los demás deben descubrirlo. El impostor tiene que sobrevivir sin ser descubierto.</div>
            </div>
            ...
            <Link href="/registrar-partida?game=impostor" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: 'transparent', color: 'var(--text-soft)', border: '1px solid var(--border)', borderRadius: 12, padding: '12px 20px', textDecoration: 'none', fontSize: 14, fontWeight: 600, fontFamily: FONT }}>
              📋 Registrar partida
            </Link>
          </div>
          </div>
