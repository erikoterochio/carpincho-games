        ...
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          ...
          <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ background: '#0d0d1a', borderRadius: 14, padding: '18px 16px', border: '1px solid #1e1736' }}>
              <div style={{ fontSize: 13, color: '#706c7e', lineHeight: 1.7 }}>Un jugador recibe una palabra diferente. Los demás deben descubrirlo. El impostor tiene que sobrevivir sin ser descubierto.</div>
            </div>
