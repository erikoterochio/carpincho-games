        ...
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <div style={{ background: 'linear-gradient(135deg, #0c4a6e 0%, #0284c7 55%, #38bdf8 100%)', padding: '26px 20px 30px', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ maxWidth: '58%' }}>
              ...
              <div style={{ fontSize: 32, fontWeight: 700, color: '#ffffff', lineHeight: 1, marginBottom: 10, fontFamily: FONT }}>Tabú</div>
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.72)', lineHeight: 1.5, fontFamily: FONT }}>Describí la palabra sin usar las prohibidas.</div>
            </div>
          </div>
          ...
          <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ background: '#0d0d1a', borderRadius: 14, padding: '18px 16px', border: '1px solid #1e1736' }}>
              <div style={{ fontSize: 13, color: '#706c7e', lineHeight: 1.7 }}>Tenés que hacer que tu equipo diga la palabra clave — pero hay palabras prohibidas que no podés usar. Si las decís, perdés el punto.</div>
            </div>
            <a href="/tabu.html" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#0284c7', color: '#ffffff', borderRadius: 12, padding: '14px 20px', textDecoration: 'none', fontSize: 15, fontWeight: 700, fontFamily: FONT }}>
              🚫 Jugar Tabú
            </a>
            <Link href="/registrar-partida?game=tabu" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: 'transparent', color: '#706c7e', border: '1px solid #1e1736', borderRadius: 12, padding: '12px 20px', textDecoration: 'none', fontSize: 14, fontWeight: 600, fontFamily: FONT }}>
              📋 Registrar partida
            </Link>
          </div>
        </div>
