        ...
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          ...
          <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ background: '#0d0d1a', borderRadius: 14, padding: '18px 16px', border: '1px solid #1e1736' }}>
              <div style={{ fontSize: 13, color: '#706c7e', lineHeight: 1.7 }}>Tirá los dados hasta tres veces por turno e intentá armar las combinaciones más difíciles. Generala servida es el máximo.</div>
            </div>
            ...
            <Link href="/registrar-partida?game=generala" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: 'transparent', color: '#706c7e', border: '1px solid #1e1736', borderRadius: 12, padding: '12px 20px', textDecoration: 'none', fontSize: 14, fontWeight: 600, fontFamily: FONT }}>
              📋 Registrar partida
            </Link>
          </div>
        </div>
